    ...
    | Software Engineer
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 300 }}>
          <h1>
            Hello, I'm{" "}
            <span style={{ color: "#ff4081", fontWeight: 700 }}>
              Sandesh Dhande 👋
            </span>
          </h1>
          ...
          <p style={{ margin: "20px 0", lineHeight: 1.6, color: "#ccc" }}>
  I’m a passionate full-stack and industrial software engineer with expertise in building 
  <span style={{ color: "#ff7b00", fontWeight: 500 }}> real-time data-driven systems</span>, 
  <span style={{ color: "#ff7b00", fontWeight: 500 }}> IoT integrations</span>, and 
  <span style={{ color: "#ff7b00", fontWeight: 500 }}> modern web platforms</span>. 
  I bridge the gap between automation hardware and cloud technologies to deliver 
  scalable, efficient, and reliable software solutions.
</p>
          ...
          <div style={{ marginTop: 20 }}>
            <a
              ...
              style={{ fontSize: "1.8rem", marginRight: 20, color: "#ccc" }}
            >
              <FaLinkedin />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ fontSize: "1.8rem", color: "#ccc" }}
            >
              <FaGithub />
            </a>
          </div>
...
<div style={{ flex: 1, textAlign: "center", marginTop: 20 }}>
  <img
    ...
    style={{
      ...
      borderRadius: "50%",
      objectFit: "cover",
      border: "3px solid rgba(255, 123, 0, 0.6)",
      boxShadow: "0 0 25px rgba(255, 64, 129, 0.3)",
      transition: "transform 0.4s ease, box-shadow 0.4s ease",
    }}
    onMouseOver={(e) => {
      e.currentTarget.style.transform = "scale(1.05)";
      e.currentTarget.style.boxShadow = "0 0 35px rgba(255, 123, 0, 0.5)";
    }}
    onMouseOut={(e) => {
      e.currentTarget.style.transform = "scale(1)";
      e.currentTarget.style.boxShadow = "0 0 25px rgba(255, 64, 129, 0.3)";
    }}
  />
</div>
...
<section style={{ padding: "80px 0" }}>
  ...
  >
    I am a <b>Software Engineer</b> with a strong focus on <b>industrial
    automation, full-stack development, and real-time system engineering</b>.
    My core expertise lies in designing <b>scalable industrial platforms</b> that
    connect hardware, sensors, and control systems to intelligent web
    applications for <b>data visualization, analytics, and process optimization</b>.
    <br />
    <br />
    Over the years, I have worked on projects involving <b>real-time machine
    monitoring</b>, <b>data logging and reporting systems</b>, <b>automated OEE
    tracking</b>, and <b>IoT-based industrial solutions</b>. I specialize in
    integrating <b>OPC-UA</b> and <b>Modbus</b> protocols for seamless data
    acquisition, leveraging technologies like <b>Node.js, Next.js, Python, SQL
    Server, Redis, and Docker</b> to build robust, production-grade systems.
    <br />
    <br />
    ...
    <br />
    <br />
    With a background in <b>industrial electromechanical systems</b>, I bring
    a unique blend of <b>domain knowledge</b> and <b>software expertise</b>,
...
<section id="experience" style={{ padding: "80px 0" }}>
  ...
  >
    <li>
      Designed and developed <b>real-time industrial monitoring platforms</b> for
      machine status tracking, downtime analysis, and <b>OEE performance
      optimization</b>.
    </li>
    <li>
      Built modular web systems using <b>Next.js, Node.js, and Express</b>,
      integrating with backend APIs for <b>QC checklists, pack validation, and
      production data management</b>.
    </li>
    <li>
      Implemented seamless communication between edge devices and web servers via
      <b>OPC-UA</b> and <b>Modbus</b> protocols, ensuring high-frequency data
      acquisition and process automation.
    </li>
    <li>
      Created <b>microservice-based APIs</b> for data validation, machine
      interlock control, and vision inspection integration, improving reliability
      of production line systems.
    </li>
    <li>
      Engineered dynamic UI dashboards using <b>Material UI</b> and <b>TanStack
      Table</b> for interactive checklist editing, live status display, and
    ...
    <li>
      Improved data throughput by implementing <b>Redis caching</b> and <b>MSSQL
      query optimization</b>, reducing API latency and improving system
      performance in multi-line environments.
    </li>
    <li>
      Developed <b>cell scanning</b> and <b>pack start systems</b> with real-time
      validation, barcode scanning, and <b>SweetAlert2 feedback workflows</b> for
      enhanced operator UX.
    </li>
    <li>
      Collaborated with cross-functional teams to align <b>software logic with
      industrial automation requirements</b>, ensuring integration with PLCs,
      sensors, and MES-level systems.
    </li>
  </ul>
</section>
...
<section id="projects" style={{ padding: "80px 0" }}>
  ...
  {[
    ...
    >
      <h3 style={{ color: "#ff7b00", marginBottom: "10px" }}>{proj.title}</h3>
...
<section id="skills" style={{ padding: "80px 0" }}>
  ...
  <ul style={{ color: "#ccc", lineHeight: 1.9, fontSize: "1rem" }}>
    <li>
      <b>Programming Languages:</b> Java, JavaScript (ES6+), TypeScript, Python,
      SQL, Bash
      <br />
    ...
    <li>
      <b>Databases:</b> Microsoft SQL Server, MySQL, Redis, PostgreSQL, SQLite
      <br />
      <span style={{ color: "#aaa" }}>
    ...
    <li>
      <b>DevOps & Tools:</b> Docker, Jenkins, GitHub CI/CD, PM2, Nginx, Postman,
      VS Code
      <br />
      <span style={{ color: "#aaa" }}>
    ...
    <li>
      ...
      Processing, System Integration, Automation Workflows, Performance Tuning,
      Security Hardening, Reporting Automation
      <br />
      <span style={{ color: "#aaa" }}>
        Adept at bridging industrial automation with modern software systems to
        deliver smart, connected manufacturing solutions.
      </span>
    </li>
  </ul>
</section>
...
<section id="education" style={{ padding: "80px 0" }}>
  ...
  <div style={{ color: "#ccc", lineHeight: 1.9, fontSize: "1rem" }}>
    ...
    <div style={{ marginBottom: "30px" }}>
      ...
      Management, Pune (Savitribai Phule Pune University) — <b>2021 – 2023</b>
      </p>
      <ul style={{ paddingLeft: "20px", listStyleType: "disc" }}>
        <li>
          Graduated with <b>First Class with Distinction</b> — Top 5% in the
          batch.
        </li>
        <li>
        ...
        <li>
          ...
          Designed and developed a full-stack web platform to enable farmers and traders
          ...
          <ul style={{ marginTop: "6px", paddingLeft: "25px" }}>
            ...
            <li>Built using <b>React, Java, MySQL, and Tailwind CSS</b>.</li>
          </ul>
        </li>
        <li>
          <b>Major Project 2 – Online News24 Portal:</b>  
          Developed a modern, multi-user content management and news publishing system.  
          Key Highlights:
          <ul style={{ marginTop: "6px", paddingLeft: "25px" }}>
            ...
            <li>Developed using <b>Python, HTML, CSS, and MySQL</b>.</li>
          </ul>
        </li>
      </ul>
    </div>
    ...
    <div>
      ...
      <p style={{ margin: "5px 0", color: "#bbb" }}>
        K.R.T. Arts, B.H.
      Commerce and A.M. Science (KTHM) College, Nashik (Savitribai Phule Pune
      University) — <b>2018 – 2021</b>
      </p>
      <ul style={{ paddingLeft: "20px", listStyleType: "disc" }}>
        <li>
...
>
  ...
  >
    ...
    innovative ideas related to software development and automation systems.  
